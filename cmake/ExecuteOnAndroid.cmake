...
execute_process(
   COMMAND ${ANDROID_NDK}/../platform-tools/adb shell "cd /data/local/tmp;su root sh -c 'source ./ignored.sh LD_LIBRARY_PATH=/data/local/tmp:/data/local/tmp/lib:/data/local/tmp/data TMPDIR=/data/local/tmp HOME=/ ./${UNITTEST_FILENAME} ${TEST_PARAMETER};echo exit code $?'"
